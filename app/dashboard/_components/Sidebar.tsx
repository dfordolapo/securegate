...
import { Shield, LayoutDashboard, ShieldAlert, Activity, UserCheck, Settings, LogOut } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <div className="flex flex-col w-64 bg-sidebar border-r border-border h-full z-20">
